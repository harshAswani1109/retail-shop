...
export default function Home() {
  return (
    <div className="container h-screen pt-12 w-full">
      <div className="flex flex-wrap items-center justify-center w-full">
        ...
        <div className="w-full shrink-0 grow-0 basis-auto md:px-6 lg:w-7/12">
          <div className="mb-12 flex justify-center items-center text-3xl">
            ...
            <div className="ml-4 grow">
              <p className="mb-1 font-bold text-white">
                See you all products any time at one place
              </p>
            </div>
          </div>
          ...
          <div className="mb-12 flex justify-center items-center text-3xl">
            ...
            <div className="ml-4 grow">
              <p className="mb-1 font-bold text-white">
                Update your products at any time
              </p>
            </div>
          </div>
          ...
          <div className="flex justify-center items-center text-3xl">
            ...
            <div className="ml-4 grow">
              <p className="mb-1 font-bold text-white">Live analytics</p>
            </div>
          </div>
        </div>
      </div>
